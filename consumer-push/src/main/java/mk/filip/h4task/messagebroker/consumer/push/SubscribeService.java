...
public class SubscribeService {
    ...
    public void subscribeAtBroker() {
        ...
        String healthcheckEndpoint = "http://" + hostName + ":" + serverPort + Config.HEALTHCHECK_ENDPOINT;
        String pushEndpoint = "http://" + hostName + ":" + serverPort + Config.PUSH_CONSUMER_MESSAGE_ENDPOINT;
